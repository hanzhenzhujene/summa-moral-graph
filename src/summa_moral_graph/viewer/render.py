...
def inject_viewer_css() -> None:
    st.markdown(
        ...
        .smgv-related-banner {
          position: relative;
          margin: 0.06rem 0 0.72rem 0;
          padding: 0.82rem 0.92rem 0.84rem 0.92rem;
          border-radius: 20px;
          border: 1px solid rgba(139, 68, 46, 0.16);
          background:
            linear-gradient(135deg, rgba(255, 252, 248, 0.98), rgba(244, 237, 228, 0.94));
          box-shadow: 0 10px 26px rgba(29, 39, 49, 0.05);
          overflow: hidden;
        }

        .smgv-related-banner::before {
          content: "";
          position: absolute;
          inset: 8px;
        ...
        .smgv-related-links a {
          ...
          font-weight: 700;
          letter-spacing: 0.02em;
          box-shadow: 0 6px 14px rgba(29, 39, 49, 0.04);
          transition:
        ...
        .smgv-related-links a:hover {
          transform: translateY(-1px);
          color: var(--smg-accent);
          border-color: rgba(139, 68, 46, 0.24);
...
def project_callout(
    *,
    ...
    st.markdown(
        (
            "<div class='smgv-related-banner'>"
            f"<div class='smgv-related-kicker'>{escape(kicker)}</div>"
            f"<div class='smgv-related-title'>{escape(title)}</div>"
            f"<div class='smgv-related-copy'>{escape(body)}</div>"
            f"<div class='smgv-related-links'>{links_html}</div>"
            "</div>"
        ),
        unsafe_allow_html=True,
    )

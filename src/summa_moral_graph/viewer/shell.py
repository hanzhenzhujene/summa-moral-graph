...
def _render_home(data: ViewerAppData) -> None:
    ...
    with main_right:
        project_callout(
            kicker="Also check out",
            title="Summa Virtue Alignment",
            body=(
                "A later subsidiary project by Jenny Zhu: Christian-virtue SFT built "
                "from this graph, corpus, and reviewed evidence workflow."
            ),
            links=[
                ("GitHub repo", "https://github.com/hanzhenzhujene/summa-virtue-alignment"),
                ("Hugging Face release", "https://huggingface.co/JennyZhu0822/summa-virtue-qwen2.5-1.5b"),
            ],
        )
